...
> policies — **206 tests**) is included with your purchase under the
...
| ![206 tests passing](docs/screenshots/S6-vitest-206-passed-postgres.png) | Verbatim `npm test` output — 206 passing |

</details>

## Status

**Version**: 0.1.1 | **Last Updated**: 2026-09-08 | **License**: Proprietary

[![Changelog](https://img.shields.io/badge/changelog-CHANGELOG.md-blue)](CHANGELOG.md)
[![Version](https://img.shields.io/badge/version-0.1.1-green)](https://github.com/verdantstack/sveltekit-postgres-starter/releases)
...
- [x] Tests: **206 passing** against a real Postgres test database
...
# 4. Test & check
npm test                    # 206 tests (needs TEST_DATABASE_URL; docker-compose's test-db)
