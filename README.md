...
> policies — **194 tests**) is included with your purchase under the
...
| ![194 tests passing](docs/screenshots/S6-vitest-194-passed-postgres.png) | Verbatim `npm test` output — 194 passing |

</details>

## Status

**Version**: 0.1.0 | **Last Updated**: 2026-08-31 | **License**: Proprietary

[![Changelog](https://img.shields.io/badge/changelog-CHANGELOG.md-blue)](CHANGELOG.md)
[![Version](https://img.shields.io/badge/version-0.1.0-green)](https://github.com/verdantstack/sveltekit-postgres-starter/releases)
...
- [x] Tests: **194 passing** against a real Postgres test database
...
# 4. Test & check
npm test                    # 194 tests (needs TEST_DATABASE_URL; docker-compose's test-db)
...
| `docs/` | architecture · rbac · billing · testing · deployment · versioning |
