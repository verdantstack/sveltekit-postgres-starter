...
<p align="center">
  <a href="https://verdantstack.dev/products/sveltekit-postgres-starter/">Documentation & guides →</a>
</p>
...
> policies — **262 tests**) is included with your purchase under the
...
website: https://verdantstack.dev/products/sveltekit-postgres-starter/
...
| ![262 tests passing](docs/screenshots/S6-vitest-262-passed-postgres.png)                       | Verbatim `npm test` output — 262 passing         |

</details>

## Status

**Version**: 0.1.6 | Last Updated: 2026-09-25 | **License**: Proprietary

[![Changelog](https://img.shields.io/badge/changelog-CHANGELOG.md-blue)](CHANGELOG.md)
[![Version](https://img.shields.io/badge/version-0.1.6-green)](https://github.com/verdantstack/sveltekit-postgres-starter/releases)
...
- [x] Invites: single-use hashed tokens, 7-day expiry, revoke, atomic claim in one transaction (per-org row lock → seat check → claim → membership → audit)
...
- [x] Tests: **262 passing** against a real Postgres test database
...
# 4. Test & check
npm test                    # 262 tests (needs TEST_DATABASE_URL; docker-compose's test-db)
