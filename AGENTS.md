...
**Status:** v0.1.6 — 262 tests passing against a real Postgres test database, svelte-check clean, production build clean. ≥ 95% coverage enforced.
...
npm test                 # vitest suite (262 tests, real Postgres via TEST_DATABASE_URL)
...
- **Run:** `npm test`
- **Current count:** 262 tests across 13 suites
