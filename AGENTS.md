...
**Status:** v0.1.2 — 206 tests passing against a real Postgres test database, svelte-check clean, production build clean.
...
npm test                 # vitest suite (206 tests, real Postgres via TEST_DATABASE_URL)
...
- **Run:** `npm test`
- **Current count:** 206 tests across 9 suites
