...
2. **Clone a specific tag**:
   ```bash
   git clone --branch v0.1.0 https://github.com/verdantstack/sveltekit-postgres-starter.git
   ```
3. **Download a specific version**:
   ```bash
   curl -L https://github.com/verdantstack/sveltekit-postgres-starter/archive/refs/tags/v0.1.0.zip -o starter-v0.1.0.zip
   ```
